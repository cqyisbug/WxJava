...
public interface WxCpTpMessageService {
   ...
   */
  WxCpMessageSendResult send(String corpId, WxCpMessage message) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpMessageSendStatistics getStatistics(String corpId, int timeType) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpLinkedCorpMessageSendResult sendLinkedCorpMessage(String corpId, WxCpLinkedCorpMessage message) throws WxErrorException;
}
