...
public interface WxCpTpDepartmentService {
   ...
   */
  Long create(String corpId, WxCpTpDepart depart) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  List<WxCpTpDepart> list(String corpId, Long id) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  void update(String corpId, WxCpTpDepart group) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  void delete(String corpId, Long departId) throws WxErrorException;
